...
# Conceptos básicos: datos espaciales
...
Los datos espaciales pueden ser representados utilizando vector and raster data.

Actualmente, los paquetes principales en R para gestionar y analizar datos espaciales son:

- **Paquete sf (Pebesma, 2022)**
- **Paquete terra (Hijmans, 2022)**

En lo sucesivo, el curso-taller se desarrollará con base en datos espaciales vectoriales. No se usarán más datos raster.
